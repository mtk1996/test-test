            ...
            <div class="col-8">
                <div class="p-3 card">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{asset('/images/'.$product->image)}}" width="100" class="img-thumbnail" alt="">
                    </div>
                    <div class="form-group">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$product->total_quantity}}"
                            name="total_quantity">
                    </div> --}}
                    <div class="form-group">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$product->buy_price}}" name="buy_price">
                    </div> --}}
                    {{-- <div class="form-group">
                ...
                <div class="card p-3">
                    <div class="form-group">
                        ...
                        <select name="supplier_id" id="supplier">
                            ...
                            <option value="{{$s->id}}" @if($s->id==$product->supplier_id)
                                selected
                                @endif
                                >{{$s->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category">
                            ...
                            <option value="{{$s->id}}" @if($s->id==$product->category_id)
                                selected
                                @endif
                                >{{$s->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="brand_id" id="brand">
                            @foreach ($brand as $s)
                            <option value="{{$s->id}}" @if($s->id==$product->brand_id)
                                selected
                                @endif
                                >{{$s->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="color_id[]" id="color" multiple>
                            @foreach ($color as $s)
                            <option value="{{$s->id}}" @foreach ($product->color as $selectedC )
                                @if($selectedC->id==$s->id)
                                selected
                                @endif
                                @endforeach
